...
$GLOBALS['TL_LANG']['tl_regina_settings']['regina'] = array(
    ...
    'useCacheRegina' => array('Bilder-Cache aktivieren', 'Wenn diese Option aktiv ist werden die Bilder zwischengespeichert.'),
    ...
    'hdRatioRegina' => array('Pixelverhältins für HD Geräte', 'Geben sie an wie das Verhältnis der Pixel bei Geräten mit Hochauflösenden Displays sein soll (Standard = 2)'),
    'mobiRatioRegina' => array('Pixelverhältins für mobile Geräte', 'Geben sie an wie das Verhältnis der Pixel bei mobilen Geräten sein soll (Standard = 1.5)'),
    ...
    'explainRegina' => array(
        ...
        . "<ul>"
            ...
            . "<li>RewriteRule muss dafür zwingend aktivert werden. Der Server muss mod_rewrite unterstützen.</li>"
            . "<li>Damit Sie mit hochauflösenden Bildern arbeiten können, müssen sämtliche Bilder egal ob Layout oder Inhalte in mindestens der doppelten Auflösung auf dem Server gespeichert werden. Das bedeutet: wollen Sie ein Bild in 350x150px anzeigen, sollte die Auflösung des Bildes mindesten 700x300px betragen.</li>"
        . "</ul>"
    )
);
 ?>
